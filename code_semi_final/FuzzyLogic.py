...
rule6 = ctrl.Rule(distance_to_obstacle_x['gauche'] & distance_to_obstacle_y['milieu'] & incoming_direction['RIGHT'], direction['DOWN']) #OU DOWN
...
rule32 = ctrl.Rule(distance_to_obstacle_x['droite'] & distance_to_obstacle_y['milieu'] & incoming_direction['LEFT'], direction['UP'])
